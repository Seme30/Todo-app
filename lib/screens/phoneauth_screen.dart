      ...
      body: SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            ...
            InkWell(
              onTap: () {
                authServcie.signInWithPhoneNumber(
      ...
      child: Center(
        child: TextFormField(
          ...
          decoration: InputDecoration(
              ...
              hintStyle:
                  TextStyle(color: Colors.white54, fontSize: Dimensions.font16),
              ...
              prefixIcon: Padding(
                ...
                child: Text(
                  '+251',
                  style: TextStyle(
                      color: AppColors.textColor, fontSize: Dimensions.font16),
                ),
              ),
              suffixIcon: InkWell(
                onTap: wait
                    ...
                    : () async {
                        ...
                        await authServcie.verifyPhoneNumber(
                ...
                child: Padding(
                  ...
                  child: Text(
                    buttonName,
                    style: TextStyle(
                      color: wait ? AppColors.textColor : AppColors.textColor,
                      fontSize: Dimensions.font16,
