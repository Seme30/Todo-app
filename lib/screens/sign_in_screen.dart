            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      BigText(text: 'Continue with phone', color: AppColors.textColor,)
                    ],
                  ),
                ),
              ),
                          ...
                          onTap: (){},
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: AppColors.secColor
                                    ...
                                    child: Center(child: BigText(text: "Sign In", color: AppColors.textColor)),
                                  ),
                              ),
                      ],
                    ),
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    BigText(text: 'Do not have an Account?', color: AppColors.textColor,),
                    SizedBox(width: Dimensions.width20,),
                    InkWell(
                      onTap: (){
                      },
                      child: BigText(text: 'Sign Up', color: AppColors.textColor,),
                    ),
                  ],),
              ),
